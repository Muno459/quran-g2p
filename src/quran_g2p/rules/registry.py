...
RULINGS: tuple[Ruling, ...] = (
    ...
    Ruling("R014B_ISTIFHAM_TASHEEL", "P1",
         ...
         "SPEC-012",
         "الشاطبية أبيات 192-194؛ النشر 1:377-378",
    ...
    Ruling("R110_BADAL_IBTIDA", "P3",
         ...
         "SPEC-110",
         "الجزرية؛ هداية القاري 2:482؛ النشر 1:390",
    ...
    Ruling("R120_ISKAN", "P4",
         ...
         "iskan al-waqf",
         "SPEC-120",
         "النشر 2:120 (الوقف بالسكون هو الأصل)",
         ("pausal-iskan-alamin",)),
    ...
    Ruling("R123_RAWM", "P4",
         ...
         "SPEC-123",
         "الشاطبية أبيات 368-373؛ النشر 2:121؛ التيسير 58-59",
    ...
    Ruling("R131_NOON_WIQAYA", "P5",
         "نون الوقاية بين التنوين وهمزة الوصل",
         "noon al-wiqaya resolving tanween + wasl",
         "SPEC-131",
         "(التقاء الساكنين)؛ هداية القاري",
         ("wiqaya-khayran",)),
    Ruling("R132_SAKT", "P5",
    ...
    Ruling("R200_QALQALAH_SUGHRA", "P11",
         ...
         "qalqalah sughra",
         "SPEC-200",
         "الشاطبية بيت 1159 «وفي قطب جد خمس قلقلة»؛ النشر 1:203",
    ...
    Ruling("R210_ISTILA", "P12",
         ...
         "SPEC-210",
         "المقدمة الجزرية أبيات 20-26؛ النويري 1:237-238",
    ...
    Ruling("R211_REH", "P12",
         ...
         "SPEC-210",
         "الجزرية باب الراءات؛ هداية القاري 1:130",
    ...
    Ruling("R211_WAQF_KHILAF", "P12",
         ...
         "SPEC-210",
         "النشر 2:105، 2:110؛ النويري 2:33؛ هداية القاري 1:130-133",
         ("sup-misr-qitr-asr",)),
    ...
    Ruling("R214_IKHFA_TAFKHEEM", "P12",
         ...
         "SPEC-210",
         "هداية القاري 1:181-182؛ لطائف الإشارات 1:366-367",
